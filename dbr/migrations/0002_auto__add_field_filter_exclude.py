...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.exclude'
        db.add_column('dbr_filter', 'exclude', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Filter.exclude'
        db.delete_column('dbr_filter', 'exclude')
