...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Annotate.field'
        db.alter_column('dbr_annotate', 'field', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'GroupBy.field'
        db.alter_column('dbr_groupby', 'field', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'Column.field'
        db.alter_column('dbr_column', 'field', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'Aggregate.field'
        db.alter_column('dbr_aggregate', 'field', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'Chart.element_tag'
        db.alter_column('dbr_chart', 'element_tag', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'Chart.field'
        db.alter_column('dbr_chart', 'field', self.gf('dbr.models.DbrModelAttrField')(max_length=250))

        # Changing field 'Filter.column'
        db.alter_column('dbr_filter', 'column', self.gf('django.db.models.fields.CharField')(max_length=100))


    models = {
        'dbr.aggregate': {
            'Meta': {'object_name': 'Aggregate'},
            'field': ('dbr.fields.DbrModelAttrField', [], {'max_length': '250'}),
        ...
        'dbr.chart': {
            ...
            'element_tag': ('dbr.fields.DbrModelAttrField', [], {'max_length': '250', 'blank': 'True'}),
            'field': ('dbr.fields.DbrModelAttrField', [], {'max_length': '250'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dbr.filter': {
            ...
            'column': ('dbr.fields.DbrModelAttrField', [], {'max_length': '250'}),
